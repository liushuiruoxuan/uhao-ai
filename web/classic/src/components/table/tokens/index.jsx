...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-uhao-api-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-uhao-api-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-uhao-api-container') return true;
      return (
