...
import (
	...
	"github.com/QuantumNous/uhao-api/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "uhao-api:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "uhao-api:channel_affinity_usage_cache_stats:v1"
)
