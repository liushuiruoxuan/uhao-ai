...
```bash
# If you have a pre-built binary (e.g., uhao-api-macos)
cp ../uhao-api-macos ../uhao-api
```
...
- Store database in `../data/uhao-api.db`
...
### Database Location
- **Development**: `../data/uhao-api.db` (project directory)
- **Production**:
