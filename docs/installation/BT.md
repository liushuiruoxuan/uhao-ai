...
1. 在宝塔面板中创建网站目录，如 `/www/wwwroot/uhao-api`
...
services:
  uhao-api:
    image: calciumion/uhao-api:latest
    container_name: uhao-api
    restart: always
    ports:
      - "3000:3000"
    volumes:
...
```bash
# 拉取最新镜像
docker pull calciumion/uhao-api:latest
...
- [GitHub 仓库](https://github.com/QuantumNous/uhao-api)
